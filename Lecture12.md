...
SQFlite is used for working with SQLite in Flutter. In order to use SQLite, Flutter has a package called `SQFlite`. Add `sqflite:` in `pubspec.yaml` file before using it.
